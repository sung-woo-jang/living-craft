...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      '정찰제는 미리 정해진 가격으로 제공되는 서비스이며, 견적제는 현장 상황에 따라 맞춤 견적을 제공하는 서비스입니다. 정찰제는 즉시 예약 확정이 가능하며, 견적제는 상담 후 견적 확정 절차가 필요합니다.',
  },
  {
    id: '4',
    category: '서비스',
  ...
  },
  {
    ...
    answer:
      '네, 견적 상담은 무료로 제공됩니다. 현장 방문 상담도 무료이며, 상담 후 계약하지 않으셔도 비용이 발생하지 않습니다.',
  },
];
